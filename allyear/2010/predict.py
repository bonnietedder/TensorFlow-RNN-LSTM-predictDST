...
f=open('/Users/apple/Desktop/tensorflow/DST/allyear/2010/2010dstdata.csv')
...
#获取测试集
def get_test_data(time_step=20,test_begin=6001):
...
def train_lstm(batch_size=60,time_step=20,train_begin=0,train_end=6000):
...
def prediction(time_step=20):
    ...
    with tf.Session() as sess:
        ...
        plt.xticks(new_ticks,[r'$2010$', r'$2011$', r'$2012$', r'$2013$', r'$2014$',r'$2015$',r'$2016$',r'$2017$',r'$2018$',r'$2019$'])
        plt.show()
