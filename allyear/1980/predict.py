...
f=open('/Users/apple/Desktop/tensorflow/DST/allyear/1980/1980dstdata.csv')
...
def prediction(time_step=20):
    ...
    with tf.Session() as sess:
        ...
        plt.title('1980-1989 DST')
        plt.ylabel('Dst Index /nT')
        plt.xlabel('year')
        plt.legend(loc='best')
        new_ticks=np.linspace(0,len(test_predict),10)
        #plt.xticks(new_ticks,[r'$1$', r'$2$', r'$3$', r'$4$', r'$5$',r'$6$',r'$7$',r'$8$',r'$9$',r'$10$',r'$11$',r'$12$'])
        plt.xticks(new_ticks,[r'$1980$', r'$1981$', r'$1982$', r'$1983$', r'$1984$',r'$1985$',r'$1986$',r'$1987$',r'$1988$',r'$1989$'])
        plt.show()
