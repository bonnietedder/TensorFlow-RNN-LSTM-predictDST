...
f=open('/Users/apple/Desktop/tensorflow/DST/allyear/1963/1963dstdata.csv')
df=pd.read_csv(f)     #读入数据
data=df.iloc[:,2:10].values  #取第3-10列

#获取训练集
def get_train_data(batch_size=60,time_step=20,train_begin=0,train_end=12000):
    batch_index=[]
...
#获取测试集
def get_test_data(time_step=20,test_begin=12001):
...
def train_lstm(batch_size=60,time_step=20,train_begin=0,train_end=12000):
    # 训练样本中第1 - 12000个样本，每次取20个
    X=tf.placeholder(tf.float32, shape=[None,time_step,input_size])
    Y=tf.placeholder(tf.float32, shape=[None,time_step,output_size])
    batch_index,train_x,train_y=get_train_data(batch_size,time_step,train_begin,train_end)

    print(np.array(train_x).shape)#11980 20 7 
    print(np.array(train_y).shape)#11980, 20, 1
    print(batch_index)
     #相当于总共11980句话，每句话20个字，每个字7个特征,对于这些样本每次训练60句话
...
def prediction(time_step=20):
    ...
    with tf.Session() as sess:
        ...
        plt.title('1963-1979 DST')
        plt.ylabel('Dst Index /nT')
        plt.xlabel('year')
        plt.legend(loc='best')
        new_ticks=np.linspace(0,len(test_predict),17)
        #plt.xticks(new_ticks,[r'$1$', r'$2$', r'$3$', r'$4$', r'$5$',r'$6$',r'$7$',r'$8$',r'$9$',r'$10$',r'$11$',r'$12$'])
        plt.xticks(new_ticks,[r'$1963$', r'$1964$', r'$1965$', r'$1966$', r'$1967$',r'$1968$',r'$1969$',r'$1970$',r'$1971$',r'$1972$',r'$1973$',r'$1974$',r'$1975$',r'$1976$',r'$1977$',r'$1978$',r'$1979$'])
        plt.show()
